  ...
  return (
    <section className='flex-col items-center text-center'>
      <div>
        ...
        <button className='bg-white text-black' onClick={handleSubmit_bare}>Submit</button>
      </div>
      <div className='flex-col'>
        <h1>Open AI Second check with User input</h1>
        <input className='bg-white text-black' type="text" value={userInput} onChange={handleInputChange} />
        <button className='bg-blue-500 text-black' onClick={handleSubmit}>Submit</button>
      </div>
      <div className='flex-col'>
        <h1>Open AI third check with User input</h1>
        <button className='bg-blue-500 text-black' onClick={handleSubmit_edge}>Submit</button>
      </div>
      <div>{response}</div>
